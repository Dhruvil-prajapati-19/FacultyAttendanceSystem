...
class LoginView(FacultyLoginMixin, StudentLoginMixin, View):
    ...
    def post(self, request):
        if 'username' in request.POST and 'password' in request.POST:
            ...
            return self.handle_faculty_login(request)

        elif 'enrollment_no' in request.POST and 'student_password' in request.POST:
            # Student login attempt
            return self.handle_student_login(request)
