...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('enrollment_no', models.CharField(blank=True, max_length=20, null=True, unique=True, verbose_name='Enrollment Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timetable_rollout', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='student_rollouts', to='FacultyAttendanceSystem.timetablerollouts', verbose_name='Timetable Rollout')),
            ],
        ),
        migrations.CreateModel(
            name='WorkShift',
