# Generated by Django 5.0.4 on 2024-08-21 19:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='related_classes', to='FacultyAttendanceSystem.semester')),
            ],
        ),
        migrations.CreateModel(
            name='Students',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('enrollment_no', models.CharField(blank=True, max_length=20, null=True, verbose_name='Enrollment Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='class_rollout', to='FacultyAttendanceSystem.timetable', verbose_name='Class definition')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timetable_rollout', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='student_rollouts', to='FacultyAttendanceSystem.timetablerollouts', verbose_name='Timetable Rollout')),
            ],
        ),
        migrations.CreateModel(
            name='WorkShift',
